...
export default function Home() {
  ...
  return (
    <div className={`${theme ? "dark" : ""} select-none dark:text-sky-100`}>
      <main
        className="h-screen flex items-center justify-center break-all 
      ...
      >
        <motion.div
          ...
          className="shadowCustom w-192 h-128 rounded-lg p-14 flex flex-col z-2
        ...
        >
          <div className="flex">
            ...
            />
            <div className="pl-4 text-6xl w-full">
              <p>Oleksander</p>
              <p>Novikov</p>
              <p className="text-4xl text-nowrap">Aspiring Web-Developer</p>
            </div>
          </div>
